...
const About = () => {
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <Biography
        imageurl="https://stream-blog-v2.imgix.net/blog/wp-content/uploads/93812b9e3e1feff4dd3a93b4fb74a5a6/Screen-Shot-2022-07-29-at-10.37.49-AM.png?auto=format&auto=compress"
      />
    </div>
  );
};
